...
function initNavigation() {
  ...
  if (hamburger) {
    ...
    nav.addEventListener('click', (event) => {
      ...
      const isDropdownToggle = isMobile && listItem.classList.contains('nav-dropdown');
      const isSubmenuLink = isMobile && anchor.closest('.dropdown-menu');
